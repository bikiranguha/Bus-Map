...
def artificialLoad(toBus, planningFromBus, planningToBus,  planningFlowReport):
	...
	try:
		...
		'In planning, there is no connection between the pair ' + planningFromBus + ',' + planningToBus + '. Please check this input.'
