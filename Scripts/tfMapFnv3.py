...
def doTFMaps(changeLines,oldTFData,newTFData,planningBusDataDict,CAPEBusDataDict):
	...
	from generatePSData import TFPSDict # get phase shift info for all tf from RAW0620.raw
