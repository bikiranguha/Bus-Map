...
from depth3BranchConnLVLoadCAPE import Depth3Dict
...
for Bus in ComedLVLoadSet:
	...
	if Bus not in Depth3Dict.keys(): # Bus has no branches
		continue

	depth2neighbourList = Depth3Dict[Bus]
...
if __name__ == "__main__":
	...
	# combine the auto mapping and the previously done manual mapping
	with open(newMapFile,'w') as f:
		f.write(oldMaps)
		for line in mapLines:
			f.write(line)
			f.write('\n')
